    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="<?php echo e(route('about.create')); ?>" class="btn btn-primary">Add About</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
                ...
                <table class="table table-hover text-nowrap datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('about.edit',$about->id)); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1418939.cloudwaysapps.com/npgmynvhtn/public_html/resources/views/admin/About/index.blade.php ENDPATH**/ ?>