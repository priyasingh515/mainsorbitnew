            ...
            <div class="card-body table-responsive p-0 mt-2">								
                <table class="table table-hover text-nowrap datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo e($i++); ?></td>
                            <td><?php echo e($students->name ?? 'Demo'); ?></td>
                            <td>
                                <?php 
                            ...
                            <td><a href="<?php echo e(route('student.view',$students->id)); ?>"><?php echo e($students->pending_count); ?></a></td>
                            
                            <td>
                                <a href="<?php echo e(route('student.view',$students->id)); ?>">
                                    Click Here
                                </a>
                                <a href="<?php echo e(route('mpstudent.delete',$students->id)); ?>" class="text-danger" onclick="return confirm('Are you sure you want to delete this?');">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1418939.cloudwaysapps.com/npgmynvhtn/public_html/resources/views/admin/student/mpstudent_list.blade.php ENDPATH**/ ?>