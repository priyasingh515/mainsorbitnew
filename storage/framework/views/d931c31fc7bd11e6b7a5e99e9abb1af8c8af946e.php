                        ...
                        <div class="col-md-6 col-lg-4 mt-1-9">
                            <div class="card card-style4 p-1-9 p-xl-5">
                                ...
                                <ul class="list-unstyled mb-2-9">
                                    ...
                                    <li class="mb-3"><i class="fas fa-checkk text-primary me-3"></i><?php echo e($plan->description_1); ?></li>
                                ...
                                <div>
                                    <a href="javascript:void(0);" onclick="checkLogin1(<?php echo e($plan->id); ?>)" class="butn"><i class="far fa-gem icon-arrow before"></i><span
...
<?php echo $__env->make('front.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1418939.cloudwaysapps.com/npgmynvhtn/public_html/resources/views/front/ourplan.blade.php ENDPATH**/ ?>