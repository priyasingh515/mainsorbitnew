                    ...
                    <div class="container-fluid py-5">
                        <div class="row justify-content-center p-3">
                            <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                                <a href="<?php echo e(route('user.answerForm')); ?>" class="text-decoration-none">
                            ...
                            <?php if(auth()->check() && $hasPlan): ?>
                            <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                                <a href="<?php echo e(url('current_affair')); ?>" class="text-decoration-none">
                                    <div class="card shadow-lg border border-warning rounded-3 bg-light text-center py-4">
                                        <div class="card-body">
...
<?php echo $__env->make('front.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1418939.cloudwaysapps.com/npgmynvhtn/public_html/resources/views/front/user/userdash.blade.php ENDPATH**/ ?>