                            ...
                            <div id="collapse<?php echo e(Str::slug($paperType)); ?>" class="accordion-collapse collapse">
                                <div class="accordion-body">
                                    <ul class="list-group scrollable-list">
                                        ...
                                        <?php if($subjects->whereNotNull('subject_name')->count() > 0): ?>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <?php $__currentLoopData = $subjects->sortByDesc('created_at')->values(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $pdf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('front.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1418939.cloudwaysapps.com/npgmynvhtn/public_html/resources/views/front/user/cgmainspractice.blade.php ENDPATH**/ ?>