        ...
        <div class="row">
            <div class="col-md-6 col-lg-3 mb-2-5 mb-lg-0">
                <a href="/" class="footer-logo">
                    <img src="<?php echo e(asset('/public/assets/admin/img/mainsorbit.png')); ?>" height="170" width="auto" class="mb-4" alt="Footer Logo">
                </a>
        ...
        <?php if(auth()->guard()->check()): ?>
            <?php if(Auth::user()->state == 'cg'): ?>
                <a href="https://t.me/mainsorbit_cgpsc" target="_blank">
                    <img src="<?php echo e(asset('/public/assets/front/img/logos/telegram.png')); ?>" alt="" height="50" width="50">
...
</html><?php /**PATH /home/1418939.cloudwaysapps.com/npgmynvhtn/public_html/resources/views/front/layouts/footer.blade.php ENDPATH**/ ?>