...
<head>
    ...
    <!-- favicon -->
    <link rel="shortcut icon" href="<?php echo e(asset('./public/assets/admin/img/logomain.png')); ?>" />
    <link rel="apple-touch-icon" href="<?php echo e(asset('./public/assets/admin/img/logomain.png')); ?>" />
    <link rel="apple-touch-icon" sizes="72x72" href="<?php echo e(asset('./public/assets/admin/img/logomain.png')); ?>" />
    <link rel="apple-touch-icon" sizes="114x114" href="<?php echo e(asset('./public/assets/admin/img/logomain.png')); ?>" />

    <!-- plugins -->
    <link rel="stylesheet" href="<?php echo e(asset('/public/assets/front/css/plugins.css')); ?>" />

    <!-- search css -->
    <link rel="stylesheet" href="<?php echo e(asset('/public/assets/front/search/search.css')); ?>" />

    <!-- quform css -->
    <link rel="stylesheet" href="<?php echo e(asset('/public/assets/front/quform/css/base.css')); ?>">

    <!-- core style css -->
    <link href="<?php echo e(asset('/public/assets/front/css/styles.css')); ?>" rel="stylesheet" />
...
<body>
                            ...
                            <div class="menu_area alt-font">
                                <nav class="navbar navbar-expand-lg navbar-light p-0">
                                    <div class="navbar-header navbar-header-custom">
                                        <!-- start logo -->
                                        <a href="/" class="navbar-brand"><img id="logo" src="<?php echo e(asset('./public/assets/admin/img/mainsorbit.png')); ?>" alt="logo" /></a>
                                        <!-- end logo -->
                                    </div>
    ...
    <!-- jQuery -->
    <script src="<?php echo e(asset('/public/assets/front/js/jquery.min.js')); ?>"></script>
    ...
    <!-- core.min.js -->
    <script src="<?php echo e(asset('/public/assets/front/js/core.min.js')); ?>"></script>

    <!-- search -->
    <script src="<?php echo e(asset('/public/assets/front/search/search.js')); ?>"></script>

    <!-- custom scripts -->
    <script src="<?php echo e(asset('/public/assets/front/js/main.js')); ?>"></script>

    <!-- form plugins js -->
    <script src="<?php echo e(asset('/public/assets/front/quform/js/plugins.js')); ?>"></script>

    <!-- form scripts js -->
    <script src="<?php echo e(asset('/public/assets/front/quform/js/scripts.js')); ?>"></script>
...
</html><?php /**PATH /home/1418939.cloudwaysapps.com/npgmynvhtn/public_html/resources/views/front/home.blade.php ENDPATH**/ ?>