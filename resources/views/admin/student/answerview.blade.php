                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @elseif($students->assigned_evaluate_name)
                                    {{ $students->assigned_evaluate_name }}
                                @else
                                    Not Available
                                @endif
                            </td>
                            ...
                            <td>
                                ...
                                @endif
                                <a href="{{ route('student.answer.delete', $students->id) }}" 
                                    class="text-danger" 
