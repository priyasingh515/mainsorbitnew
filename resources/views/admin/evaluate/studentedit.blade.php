    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{route('studentassign.list')}}" class="btn btn-primary">View</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
                    ...
                    <div class="row">
                        ...
                        {{-- <div class="col-md-6"> --}}
                            {{-- <div class="mb-3"> --}}
                                ...
                                <input type="hidden" name="email" value="{{$studentanswerList->student_email}}"  class="form-control" placeholder="Enter Email">
                            {{-- </div> --}}
                        {{-- </div>     --}}
                        <div class="col-md-6">
                            <div class="mb-3">
