...
<head>
    ...
    <!-- favicon -->
    <link rel="shortcut icon" href="{{asset('./public/assets/admin/img/logomain.png')}}" />
    <link rel="apple-touch-icon" href="{{asset('./public/assets/admin/img/logomain.png')}}" />
    <link rel="apple-touch-icon" sizes="72x72" href="{{asset('./public/assets/admin/img/logomain.png')}}" />
    <link rel="apple-touch-icon" sizes="114x114" href="{{asset('./public/assets/admin/img/logomain.png')}}" />
                                ...
                                <nav class="navbar navbar-expand-lg navbar-light p-0 pb-0">
                                    <div class="navbar-header navbar-header-custom">
                                        ...
                                        <a href="/" class="navbar-brand"><img id="logo" src="
                                            {{asset('./public/assets/admin/img/mainsorbit.png')}}
                                            " alt="logo"/></a>
                                        <!-- end logo -->
                                    </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content custom-modal-content">
                    ...
                    <div class="modal-header">
                        <img src="{{ asset('./public/assets/admin/img/mainsorbit.png') }}" alt="Logo" height="200" width="250">
