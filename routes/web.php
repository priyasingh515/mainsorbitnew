...
Route::group(['prefix'=>'admin'],function(){
    ...
    Route::group(['middleware'=>'admin.auth'],function(){
        ...
        Route::get('/admin/doubts', [HomeController::class, 'doubtStudents'])->name('admin.doubt.students');
        Route::get('/Doubtlist/{studentId}',[HomeController::class,'studentDoubts'])->name('Doubtlist.index');
        ...
        Route::get('/questionList/{studenId}',[EvaluateController::class,'student_questionList'])->name('student.questionList');
        ...
        Route::get('/checked/{studentId}',[EvaluateController::class,'checkedList'])->name('checked.list');
        Route::get('/message/{studentId}',[EvaluateController::class,'studentMessage'])->name('message.list');
        Route::get('/Students',[EvaluateController::class,'assignStudents'])->name('studentAssign.list');
        Route::post('/send-reply', [EvaluateController::class, 'storeReply'])->name('send.reply');
        Route::get('/DoubtStudents',[EvaluateController::class,'doubtstudent'])->name('studentdoubt.list');
        Route::get('/assignStudents',[EvaluateController::class,'assignnedStudent'])->name('studentassign.list');
        ...
        Route::get('/admin/student/answer/delete/{id}', [StudentController::class, 'studentAnswerDelete'])->name('student.answer.delete');

            //Question Route
        Route::get('/cg_question',[QuestionController::class,'cgindex'])->name('cgquestion.index');
        Route::get('/mp_question',[QuestionController::class,'mpindex'])->name('mpquestion.index');
        ...
        //Mains route
        Route::get('/cg_practice_mains',[MainsController::class,'cgindex'])->name('cgmainspractice.index');
        Route::get('/mp_practice_mains',[MainsController::class,'mpindex'])->name('mpmainspractice.index');
...
Route::post('/check-active-plan', [FrontController::class, 'checkActivePlan'])->name('check.active.plan');
Route::post('/expire-active-plan', [FrontController::class, 'expireActivePlan'])->name('expire.active.plan');
...
Route::get('/cgMainsPractice', [FrontController::class, 'cgmainsPractice']);
...
Route::get('/CheckAnsList', [FrontController::class, 'allCheckAns']);
...
Route::get('/payment/{id}', [FrontController::class, 'payment'])->name('plan.payment');
