...
class QuestionController extends Controller
{
    ...
    public function cgindex(){
        ...
        return view('admin.questions.cglist',compact('questions'));
    }
    ...
    public function mpindex(){
        ...
        return view('admin.questions.mplist',compact('questions'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('file')) {
            ...
            // return redirect()->route('cgquestion.index')->with('success', 'Question Paper uploaded successfully!');
                    if ($request->state === 'cg') {
                        return redirect()->route('cgquestion.index')->with('success', 'Question uploaded successfully!');
                    } elseif ($request->state === 'mp') {
                        return redirect()->route('mpquestion.index')->with('success', 'Question uploaded successfully!');
                    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->state === 'cg') {
            return redirect()->route('cgquestion.index')->with('success', 'Question Paper deleted successfully!');
        } elseif ($request->state === 'mp') {
            return redirect()->route('mpquestion.index')->with('success', 'Question Paper deleted successfully!');
        }    }
    ...
    public function destroy($id)
    {
        ...
        $question->delete();
        $state = $question->state; // get state before delete
